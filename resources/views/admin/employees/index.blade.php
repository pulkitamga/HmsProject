                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                data-bs-target="#editEmployeeModal{{ $employee->id }}">Edit</button>
                                    ...
                                    <form action="{{ route('employees.update', $employee->id) }}" method="POST"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="position" class="form-control">
                                                <option value="nurse"
                                                    {{ $employee->position == 'nurse' ? 'selected' : '' }}>Nurse</option>
                                                <option value="doctor"
                                                    {{ $employee->position == 'doctor' ? 'selected' : '' }}>Doctor</option>
                                                <option value="accountant"
                                                    {{ $employee->position == 'accountant' ? 'selected' : '' }}>Accountant
                                                </option>
                                                <option value="other"
                                                    {{ $employee->position == 'other' ? 'selected' : '' }}>Other</option>
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                            <label>Status</label>
